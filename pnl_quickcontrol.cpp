...
// FastBrush->setWindowFlags(Qt::Tool|Qt::CustomizeWindowHint|Qt::WindowMinimizeButtonHint);
  ...
  logfile.write("\n fastpanel - part1 done");  logfile.close(); logfile.open(QFile::Append);
...
logfile.write("\n fastpanel - part2 done");  logfile.close(); logfile.open(QFile::Append);
...
logfile.write("\n fastpanel - part3 done");  logfile.close(); logfile.open(QFile::Append);
...
logfile.write("\n fastpanel - part4 done");  logfile.close(); logfile.open(QFile::Append);
...
Lfpg->setMargin(0);
logfile.write("\n fastpanel - part5 done");  logfile.close(); logfile.open(QFile::Append);
...
logfile.write("\n fastpanel - part6 done");  logfile.close(); logfile.open(QFile::Append);
