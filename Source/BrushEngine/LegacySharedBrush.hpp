...
#ifndef LEGACYSHAREDBRUSH_HPP
#define LEGACYSHAREDBRUSH_HPP

#include "NetBrushStamp.hpp"
#include "ClientBrushStamp.hpp"
...
struct BrushData {
   ...
   public:
      ...
      void Serialize(QDataStream &stream) {
          ClientStamp.ToNetBrush(Pack);
          Pack.SerializeInto(stream);
      }

      void DeSerialize(QDataStream &stream) {
          //QDataStream stream(src, QIODevice::ReadWrite);
          Pack.Deserialize(stream);
          ClientStamp.FromNetBrushStamp(Pack);
      }
